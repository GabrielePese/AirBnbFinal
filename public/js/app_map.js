...
function map() {
  var _long = document.getElementById("lo").textContent; //qui prendo il valore dall HTML. prendo il valore dalla pagaina show dall ID lo.
  ...
  var marker = new mapboxgl.Marker() // Questo ci mette il marker/puntatore sulla mappa.
  .setLngLat([_long, lat]).addTo(map);
}
