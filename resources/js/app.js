...
function autocompletesearch(){   //questo autocomplete serve per index e search
  // PARTE AUTOCOMPLETE
  var long;
  var lat;
  var city;
  var placesAutocomplete = places({
      ...
      container: document.querySelector('#address-input') //cambia id per prendere solo da index e search
    });
