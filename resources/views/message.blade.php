...
<div class="container">
    <div class="row justify-content-center">  {{-- qui fa una piccola show dell'appartamento a cui sta x scrivere --}}
    ...
    <ul>
        ...
        @foreach ($messages as $message) {{-- ciclo tutit i mex --}}
        @if ($message -> flat_id == $flat -> id) {{-- guarda se il flat_id della tabella message e'il flat id della tabella message sono uguali.  --}}
