    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                @if ( !(empty($flat -> user_id)) && (($flat -> user_id) == (Auth::user()-> id)) && $ishost == 0 ) {{-- se user ID NON e'vuoto e l'user ID e'uguale all'ID dell'user collegato e non E'un host. DIVENTA HOST --}}
                @php
                $ishost = 1;
                @endphp
                @endif
