    ...
    <div class="row justify-content-center" style="padding : 60px 0;">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('storeHost', Auth::user()-> id)}}" method="post" enctype="multipart/form-data"> {{-- enctype="multipart/form-data" Serve per la codifica la request in modo che legga file in upload --}}
                        @csrf
                        @method('POST')
                        ...
                        <input id="latitude" type="text" name="latitude" class="form-control none" value="" ondblclick="this.value=''">    {{-- per salvare lat e long. prende i  valori da app_outofrm.js da riga 27 e 28  da autocomplete--}}
